document.addEventListener("DOMContentLoaded", () => {
    ...
    // Mantenemos el ../ solo para el fetch porque el HTML está en la subcarpeta 'guia_educativa'
    fetch('../assets/json/proceso_reciclaje.json')
        ...
        .then(data => {
            ...
            data.forEach((proceso, index) => {
                ...
                // Generar etapas - Se eliminaron prefijos extras para usar la ruta del JSON
                ...
                <div class="col">
                    <div class="card h-100 shadow-sm border-0">
                        ...
                        <div class="p-3 text-center" 
                             style="background:${proceso.color_hex}">
                    ...
                    <div class="modal-dialog modal-fullscreen">
                        <div class="modal-content">
                            ...
                            <div class="modal-body p-4 p-lg-5">
                                ...
                                <h3 class="text-center mb-5 fw-bold text-uppercase">
